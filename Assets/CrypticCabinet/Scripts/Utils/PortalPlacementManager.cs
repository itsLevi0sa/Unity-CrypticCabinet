...
namespace CrypticCabinet.Utils
{
    ...
    /// </summary>
    public class PortalPlacementManager : Meta.Utilities.Singleton<PortalPlacementManager>
    {
        public PortalPlacementManager(SceneObject o)
        {
        }

        public enum LoadableSceneObject
        {
            CABINET
        }
        ...
        public struct SceneObject
        {
            ...
            public PortalPlacementVisualiser DisplayPrefab;
            public Vector3 MainPosition;
            public Vector3 WallPosition;
            public Quaternion WallRotation;
            public bool SuccessfullyPlaced;
            public Quaternion MainRotation;
            [HideInInspector] public PortalPlacementVisualiser SpawnedDisplayObject;
        }
        ...
        public List<SceneObject> RequestObjects(LoadableSceneObject objectType)
        {
        ...
        public void UpdatePlacedObject(LoadableSceneObject objectType, Vector3 mainPosition, Vector3 wallPosition,
        ...
        private static void UpdateObject(ref List<SceneObject> objects, LoadableSceneObject objectType, Vector3 mainPosition,
        ...
        private PortalPlacementVisualiser InstantiateVisualizer(ref SceneObject sceneObject)
        {
            var portalPlacementVisualiser = Instantiate(sceneObject.DisplayPrefab);
            GameObject go;
            (go = portalPlacementVisualiser.gameObject).SetActive(false);
            m_spawnedVisualiserObjects.Add(go);
            sceneObject.SpawnedDisplayObject = portalPlacementVisualiser;

            return portalPlacementVisualiser;
        }
