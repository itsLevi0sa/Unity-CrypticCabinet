...
namespace CrypticCabinet.Utils
{
    ...
    public class PortalPlacementVisualiser : MonoBehaviour
    {
        ...
        [SerializeField] private PortalPlacementManager.LoadableSceneObject m_objectType;
        ...
        public PortalPlacementManager.LoadableSceneObject GetObjectType => m_objectType;
        ...
        private PortalPlacementManager m_portalPlacementManager;
        ...
        public void Setup(PortalPlacementManager portalPlacementManager, Vector3 mainPosition, Vector3 wallPos,
            Quaternion wallRotation)
        {
            var pos = m_placeAgainstWall ? wallPos : mainPosition;
            pos.y = m_forceToGroundLevel ? 0 : pos.y;

            Setup(portalPlacementManager, pos);

            transform.rotation = wallRotation;
        }

        public void Setup(PortalPlacementManager portalPlacementManager, Vector3 position)
        {
            m_portalPlacementManager = portalPlacementManager;

            transform.position = position;
        }

        public void Setup(PortalPlacementManager portalPlacementManager, Vector3 position, Quaternion rotation)
        {
            m_portalPlacementManager = portalPlacementManager;
        ...
        public void UpdateLocation()
        {
            ...
            m_portalPlacementManager.UpdatePlacedObject(m_objectType, position, wallPosition, rotation, rotation);
        }
